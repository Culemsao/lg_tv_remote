    ...
    render() {
      ...
      <div class="remote">
        <div class="top-row">
          ...
          ${showTitle && cfg.title
            ? b ` <div class="top-title">${cfg.title}</div> `
        ...
        ${showNavigation
            ? b `
              ${showLabelNavigation && lblNavigation
                ? b `<div class="lbl">${lblNavigation}</div>`
                : A}
              <div class="pad">
...
__decorate([
    n({ attribute: false })
], LGTVRemoteCard.prototype, "config", void 0);
__decorate([
    r()
], LGTVRemoteCard.prototype, "_volume", void 0);
__decorate([
    r()
], LGTVRemoteCard.prototype, "_muted", void 0);
